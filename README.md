...
##To run this on Greasemonkey(Recommended)
  ...
  2. Create new user script, 	in namespace field add this [link]("https://webmail.iitg.ernet.in/src/right_main.php?PG_SHOWALL=1&use_mailbox_cache=1&startMessage=1&mailbox=INBOX")
